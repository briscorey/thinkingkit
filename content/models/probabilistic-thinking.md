...
one_liner: "Think in likelihoods, not certainties. Assign probabilities to outcomes instead of assuming binary results."
question_hook: "Are you treating an uncertain situation as if the outcome is guaranteed?"
description: "Probabilistic thinking means estimating the likelihood of different outcomes rather than defaulting to 'it will happen' or 'it won't happen.' It's the foundation of all good decision-making under uncertainty."
icon: "⊕"
weight: 9
