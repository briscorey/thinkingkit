    ...
    if (state.phase === 'setup') {
      ...
      app.innerHTML = `
        <div style="background:var(--color-bg-card);border:1px solid var(--color-border);border-radius:var(--radius-lg);padding:var(--space-xl);margin:var(--space-xl) 0;">
          ...
          <div style="background:var(--color-bg-warm);border-left:3px solid var(--color-amber);padding:var(--space-lg);border-radius:0 var(--radius-md) var(--radius-md) 0;margin-bottom:var(--space-lg);">
          ...
          <textarea id="pm-input" rows="3" placeholder="Describe a specific way this could fail..." style="width:100%;padding:0.75rem 1rem;background:var(--color-bg-warm);border:1px solid var(--color-border);border-radius:var(--radius-md);color:var(--color-text);font-family:var(--font-body);font-size:0.9rem;resize:vertical;margin-bottom:var(--space-md);"></textarea>
          ...
          <div style="margin-top:var(--space-xl);border-top:1px solid var(--color-border-subtle);padding-top:var(--space-lg);">
            ...
            ${state.failures.map((f, i) => `
              <div style="display:flex;gap:var(--space-md);align-items:flex-start;margin-bottom:var(--space-md);padding:var(--space-md);background:var(--color-bg-warm);border-radius:var(--radius-md);">
      ...
      app.innerHTML = `
        <div style="background:var(--color-bg-card);border:1px solid var(--color-border);border-radius:var(--radius-lg);padding:var(--space-xl);margin:var(--space-xl) 0;">
          ...
          ${state.failures.map((f, i) => `
            <div style="background:var(--color-bg-warm);border-radius:var(--radius-md);padding:var(--space-lg);margin-bottom:var(--space-md);border-left:3px solid ${f.severity==='high'?'var(--color-red)':f.severity==='medium'?'var(--color-amber)':f.severity==='low'?'var(--color-green)':'var(--color-border)'};">
